...
export interface ResponsiveSafariProps extends HTMLAttributes<HTMLDivElement> {
    url?: string;
    imageSrc?: string;
    videoSrc?: string;
    mode?: SafariMode;
...
export function ResponsiveSafari({
    imageSrc,
    videoSrc,
    url,
    mode = "default",
    ...
    return (
        <div
            ...
            style={{
                // Remove default aspect ratio if style overrides it or if we want it fluid
                aspectRatio: style?.aspectRatio ?? `${SAFARI_WIDTH}/${SAFARI_HEIGHT}`,
                ...style,
            }}
            {...props}
        >
            ...
            <svg
                ...
                preserveAspectRatio={style?.aspectRatio === "none" ? "none" : "xMidYMid meet"}
            >
                <defs>

...
const TEXT = "Générer procédure cadenassage Pompe P-402";
const FRAMES_PER_CHAR = 2;
const TYPING_START = 45;

// Typing ends at: 45 + chars * 2
const TYPING_END = 45 + TEXT.length * FRAMES_PER_CHAR; // Dynamic calculation
...
const DEZOOM_START = TYPING_END + 1;
const DEZOOM_END = DEZOOM_START + 29;
const CURSOR_START = DEZOOM_END + 1;
const CURSOR_ARRIVE = CURSOR_START + 16;
const CLICK_FRAME = CURSOR_ARRIVE + 5;
const EXIT_START = CLICK_FRAME + 13;
const EXIT_END = EXIT_START + 15;
                ...
                >
                        ...
                        rightElement={
                            <RemotionButton
                                ...
                                style={{
                                    ...
                                    width: 48,
                                    height: 48,
                                    backgroundColor: "#D32F2F" // LOTO Red
                                }}
                            >
                                <svg
                                    width="20"
                    ...
                    {showShine && (
                        <ShineBorder
                            borderWidth={2}
                            duration={3}
                            shineColor={["#FF0000", "#FF8888", "#FF0000"]} // Red/Pink shine
                        />
                    )}
                </div>
            </AbsoluteFill>

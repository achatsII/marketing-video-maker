...
export const Scene4Mobile: React.FC = () => {
    ...
    const steps = [
        ...
        { triggerFrame: t.bot1Msg, targetY: 900 },
        { triggerFrame: t.user2Typing, targetY: 750 },
        { triggerFrame: t.user2Msg, targetY: 750 },
        { triggerFrame: t.bot2Typing, targetY: 600 },
        { triggerFrame: t.bot2Msg, targetY: 450 },
    ];
    ...
    if (frame >= t.exitStart) {
        ...
        phoneY = interpolate(exitProgress, [0, 1], [phoneY, -1500]);
    }
